...
__hidden ncclResult_t baguaNetGetProperties(int dev, ncclNetProperties_v3_t *props)
{
...
__hidden ncclResult_t baguaNetFlush(void *recvComm, void *data, int size, void *mhandle)
{
